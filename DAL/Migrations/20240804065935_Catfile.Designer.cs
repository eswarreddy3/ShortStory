...
namespace DAL.Migrations
{
    ...
    [Migration("20240804065935_Catfile")]
    partial class Catfile
    {
            ...
            modelBuilder.Entity("BOL.Story", b =>
                {
                    ...
                    b.Property<string>("SSDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SSTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BOL.Story", b =>
                {
                    ...
                    b.HasOne("BOL.SSUser", "SSUserNav")
                        .WithMany("Stories")
                        .HasForeignKey("Id");

                    b.Navigation("CategoryNav");

                    b.Navigation("SSUserNav");
                });
